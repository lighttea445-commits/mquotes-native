...
export type ModalSheet = 'categories' | 'themes' | 'mix' | 'profile' | 'myquotes' | 'reflect' | 'history' | 'notifications' | 'widgets' | 'favorites' | 'journal' | 'features' | 'trial' | 'settings' | 'share' | null;
