...
const nc = StyleSheet.create({
  ...
  headline: { fontSize: 25, lineHeight: 32, textAlign: 'center' },
  subhead: { fontSize: 13, lineHeight: 19, textAlign: 'center', marginTop: 10 },
  scroll: { flex: 1 },
  ...
  preview: { flexDirection: 'row', gap: 14, borderRadius: 18, borderWidth: 1, padding: 18 },
  avatar: { width: 35, height: 35, borderRadius: 17.5, alignItems: 'center', justifyContent: 'center' },
  avatarText: { fontSize: 16, color: ON_GOLD },
  previewText: { flex: 1 },
  previewApp: { fontSize: 11, fontWeight: '600' },
  previewBody: { fontSize: 12, lineHeight: 18, marginTop: 4 },

  card: { borderRadius: 18, borderWidth: 1, paddingHorizontal: 20, paddingVertical: 18 },
  cardRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  cardLabel: { fontSize: 13 },
  cardValue: { fontSize: 13, fontWeight: '600' },
  bound: { fontSize: 11 },

  trackHit: { height: 32, justifyContent: 'center', marginVertical: 10 },
  ...
  timePill: { paddingHorizontal: 16, paddingVertical: 8, borderRadius: 11 },
